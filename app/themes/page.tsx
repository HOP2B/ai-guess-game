...
export default function Themes() {
  const [themes, setThemes] = useState<Theme[]>([
    ...
    { id: 4, name: 'celebrity', image: 'https://i.pinimg.com/736x/86/14/ca/8614ca4dbcd1f475f218dbdd05cf56c3.jpg' },
    { id: 5, name: 'football', image: 'https://sportsandgames.co.tt/wp-content/uploads/2022/05/blog_football.jpg' },
      ...
      <div className="flex-grow flex items-center justify-center">
        <div className="max-w-7xl w-full">
          <div className="grid grid-cols-3 gap-10 mb-40">
            {themes.map((theme) => (
              <Link key={theme.id} href={`/game?theme=${theme.id}`}>
